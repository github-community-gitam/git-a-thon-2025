      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-20">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 backdrop-blur-md border border-white/10 hover:border-white/20 transition-all duration-300">
            ...
            <span className="text-sm font-medium text-white/90">EPOCH 4.0 Presents</span>
          </div>

          {/* Main Title */}
          <div className="space-y-6">
            <h1 className="font-bold text-6xl sm:text-7xl md:text-8xl lg:text-9xl tracking-tight leading-none">
            ...
            {/* Subtitle */}
            <p className="text-lg sm:text-xl md:text-2xl text-white/70 font-medium max-w-2xl mx-auto leading-relaxed">
