  ...
  const expectations = [
    {
      ...
      label: "Registrations open for first 45 teams only",
    },
    {
      icon: (
        <svg
    ...
    <section id="about" className="relative">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-white/60 max-w-2xl mx-auto leading-relaxed">
          ...
          statements and build working prototypes in 24 hours with focus on
          creativity, usability, and user experience.
        </p>
      </div>
